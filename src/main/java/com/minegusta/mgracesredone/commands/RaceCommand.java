...
public class RaceCommand implements CommandExecutor {
    ...
    //Help list
    private String[] help = {"/Race Help " + ChatColor.GRAY + "- Show this help menu.", "/Race List " + ChatColor.GRAY + "- Display a list of races.", "/Race Info <Race> " + ChatColor.GRAY + "- Info on the given race.", "/Race Amount " + ChatColor.GRAY + "- Show how many players there are per race.", "/Race Reset-Perks " + ChatColor.GRAY + "- Reset all your perks.", "/Race Show " + ChatColor.GRAY + "- Show info about your race.", "/Race Cure " + ChatColor.GRAY + "- Display cure info.", "/Race Infection <Race> " + ChatColor.GRAY + "- Show how to become a race.", "/Race Recipes " + ChatColor.GRAY + "- Show all recipes related to races.", "/Perk " + ChatColor.GRAY + "- Show your race's perk tree.", "/Perk Info <Perk> " + ChatColor.GRAY + "- Show info about a specific perk.", "/Perk List <Race> " + ChatColor.GRAY + "- Show all perks for a specific race.", "/Bind " + ChatColor.GRAY + "- Bind abilities to an item."};
